...
public class CalculatorNgTest {
    ...
    private void setupGeneric() {
        c = new Calculator();
        ExtentSparkReporter spartReporter = new ExtentSparkReporter("target/report.html");
    ...
    public void test01(Method method) {
        ...
        }.getClass().getEnclosingMethod().getName()); //java reflection - get name of the curret method
    ...
    public void test03(String exp, String d1, String d2, String op, String errMess) {
        ExtentTest mytest = extent.createTest(new Object() {}.getClass().getEnclosingMethod().getName()); //java reflection - get name of the curret method
    ...
    @Test(testName = "AdditionDataProviderClassic", groups = {"addition", "calculator"},
            dataProvider = "calculatorDataProviderClassic")
