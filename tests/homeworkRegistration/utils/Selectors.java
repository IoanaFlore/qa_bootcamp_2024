...
public class Selectors {
    ...
    public static final String ACCOUNT_BUTTON = "navbarAccount";
    public static final String LOGIN_BUTON = "navbarLoginButton";

    public static final String REGISTER_URL = "Not yet a customer?";
